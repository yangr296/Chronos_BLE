...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_LATENCY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_TIMEOUT, 400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52DK_NRF52832, 1);
